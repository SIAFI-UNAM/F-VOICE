...
from src.Audio  import (mel_spectrogram_torch, spec_to_mel_torch,
                            spectrogram_torch)
from src.Text import cleaned_text_to_sequence, text_to_sequence
from src.utils import load_filepaths_and_text, load_wav_to_torch
...
class TextAudioLoader(torch.utils.data.Dataset):
    ...
    def get_audio(self, filename):
        ...
        # --- DEBUG 1: VER LA FORMA DEL AUDIO AL CARGAR ---
        #print(f"DEBUG 1 (Después de cargar): Archivo={os.path.basename(filename)}, Forma={audio.shape}")
        ...
        # --- DEBUG 2: VER LA FORMA DESPUÉS DE LA CORRECCIÓN ---
        #print(f"DEBUG 2 (Después de unsqueeze): Forma={audio_norm.shape}")
