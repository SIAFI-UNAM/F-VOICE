...
def IdChannel(id): # El parametro es un string
    ...
    # Estos dos pops son para eliminar los dos primeros indices los cuales son urls del canal y no de videos del mismo
    listaVideos.pop(0)
    listaVideos.pop(0)
...
#IdChannel("UCFJBsityvF0Z9dfxecDfm7g")